...
<embed src="pdfs/Data viz using Python-slides.pdf" type="application/pdf" width="100%" height="600px" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" />

<p align="center"><a href="pdfs/Data viz using Python-slides.pdf" class="md-button md-button--primary">Download Lecture Slides</a></p>
