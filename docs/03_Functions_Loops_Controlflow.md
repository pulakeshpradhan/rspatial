...
<embed src="pdfs/Session4_Functions_Loops_Conditionals_Control Flow_in_ Python.pdf" type="application/pdf" width="100%" height="600px" />

[Download Slides PDF](pdfs/Session4_Functions_Loops_Conditionals_Control Flow_in_ Python.pdf){ .md-button .md-button--primary }
